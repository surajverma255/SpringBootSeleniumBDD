...
public abstract class Base {
  ...
  @Autowired protected WebDriverWait wait;

  @Autowired protected ApplicationConfig applicationConfig;
  @Autowired protected JavascriptExecutor javascriptExecutor;
  ...
  public void jsClick(By by) {
    javascriptExecutor.executeScript(
        "arguments[0].click();", wait.until(ExpectedConditions.visibilityOfElementLocated(by)));
  }
